...
Answer: 154 observations, one row for every unique combination of area number and night flag. The burglery rate increases for low income levels at night but during the day there is no significant difference between burglery rates during the day in relation to the income level.
### Prompts
...
How does the relationship between income and the rate of burglaries
change between day and nighttime? You may want to highlight 1-2 particular
neighborhoods to make your point.

Thesis: Burglary rates increase significantly at night in most low income level neighborhoods. However as income levels increase, night time burglary rates do not significantly differ from the day time rates.
...
ggplot(crimes_time_ca, aes(median_income, burglary_rate)) +
  ...
  annotate("text", x = 26693, y = 19, label = "West Englewood") +
  annotate("point", x = 26693, y = 3.6378335, color = "red", size = 3) +
  annotate("text", x = 26693, y = 4.5, label = "West Englewood") +
  annotate("point", x = 18412, y = 0.0, color = "blue", size = 3) +
  annotate("text", x = 18412, y = 1, label = "Fuller Park") +
  annotate("point", x = 18412, y = 10.9631950, color = "blue", size = 3) +
  annotate("text", x = 18412, y = 12, label = "Fuller Park") +
  annotate("point", x = 68269, y = 1.1495905, color = "purple", size = 3) +
  annotate("text", x = 65269, y = 3, label = "Forest Glen") +
  annotate("point", x = 68269, y = 6.6101451, color = "purple", size = 3) +
  annotate("text", x = 65269, y = 8, label = "Forest Glen")
```
