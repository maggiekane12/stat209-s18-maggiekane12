...
**Answer**: This mean value describes the average number of crimes that resulted in an arrest.
...
**Answer**: This mean value describes the average number of crimes that were classified as a theft.
...
**Answer**: This is the total number of crimes that were classified as thefts.
...
**Answer**: Larger - the average crimes that resulted in an arrest in Humboldt Park is larger than the average of the entire city of Chicago.
...
**Answer**: Smaller - the average crimes that were classified as a theft in Humboldt Park is smaller than the average for the entire city of Chicago.
...
```{r}
ca$theft_rate <- crimes_ca$theft_sum / sum(ca$num_households) * 1000
```
...
**Answer**: Theft rate is relatively equal among most income levels. A large majrity of the thefts are bunched around the $40,000 income level. There are a few outliers with high theft rates towards the higher (~$60,000) income levels.
...
ggplot(ca, aes(median_income, theft_rate)) +
  geom_point() +
  geom_text(aes(label = area_name), size = 3)
```

What is the name of the outlier?

**Answer**: Near North Side & Loop
...
**Answer**: Both are right along Lake Michigan and are wealthier communities. 
