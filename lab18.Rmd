...
**Answer**: No, a majority lie outside of that range. Because the range is showing the range of the mean not the median.
...
```{r}
model3 <- lm_basic(age ~ 1, data = london)
reg_table(model3, level = 0.80)
```
...
**Answer**: We can say with 80% of confidence that the average age of a murder victim in London is between the ages of 33.07 and 34.65 years old.
