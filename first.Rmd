...
```{r}
fav_restaurant <- read.csv("~/Desktop/class_restaurants.csv")
...
```{r}
ggplot(fav_restaurant, aes(cuisine, cost_per_person)) +
  geom_point()
```
...
```{r}
ggplot(fav_restaurant, aes(yearly_visits, cost_per_person)) +
  geom_point()
```
...
```{r}
ggplot(fav_restaurant, aes(cuisine)) +
  geom_bar()
```
